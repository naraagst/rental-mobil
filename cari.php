...
<?php 
	...
	$mobil = mysqli_query($koneksi, "select * from mobil JOIN spesifikasi ON (mobil.id_jenismobil=spesifikasi.id_jenismobil) where mobil.merk like '%$_POST[cari]%' order by mobil.id_mobil");
	$jmldata= mysqli_num_rows($mobil);
